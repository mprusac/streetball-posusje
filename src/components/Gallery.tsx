      ...
      <div className="container mx-auto px-4">
        ...
        <div id="home-return-gallery-btn" className="flex justify-center mt-10">
          <Link 
            ...
            className="px-8 py-3 rounded-xl bg-primary/20 border border-primary text-primary font-display font-bold text-lg uppercase tracking-wider hover:bg-primary hover:text-primary-foreground transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-primary/30"
          >
            Sva galerija
          </Link>
        </div>
