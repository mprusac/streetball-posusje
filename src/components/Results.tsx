    ...
    <section id="rezultati" className="py-20">
      ...
      >
        ...
        <div className="relative max-w-[1200px] mx-auto px-14 md:px-20">
          ...
          <button
            onClick={() => scroll("left")}
            className="flex absolute left-0 md:left-0 top-[38%] md:top-1/2 -translate-y-1/2 z-10 w-8 h-8 md:w-12 md:h-12 rounded-full bg-primary items-center justify-center text-primary-foreground hover:bg-primary/90 hover:scale-110 transition-all duration-300 shadow-lg"
          >
          ...
          <button
            ...
            className="flex absolute right-0 md:right-0 top-[38%] md:top-1/2 -translate-y-1/2 z-10 w-8 h-8 md:w-12 md:h-12 rounded-full bg-primary items-center justify-center text-primary-foreground hover:bg-primary/90 hover:scale-110 transition-all duration-300 shadow-lg"
          >
