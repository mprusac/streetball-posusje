...
const sponsors = [
  ...
  { name: "Planet", tier: "Silver", image: planetLogo, borderColor: "border-[hsl(0,0%,75%)]", glowColor: "hover:[box-shadow:0_0_25px_8px_hsl(0,0%,75%,0.3)]", imgClass: "!object-contain p-4", url: "https://www.facebook.com/planetbih/" },
