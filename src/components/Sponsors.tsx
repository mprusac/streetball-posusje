...
const sponsors = [
  ...
  { name: "Bin Vest", tier: "Gold", image: binvestLogo, borderColor: "border-[hsl(48,96%,53%)]", glowColor: "hover:[box-shadow:0_0_25px_8px_hsl(48,96%,53%,0.35)]", imgClass: "!object-contain scale-[1.5]", url: "https://binvest-po.com/" },
