...
const sponsors = [
  ...
  { name: "Ž Barber Shop", image: barbershopLogo, imgClass: "!object-contain scale-[1.5]", url: null },
  ...
  { name: "Markota", image: markotaLogo, imgClass: "!object-contain scale-[1.5]", url: null },
