...
const sponsors = [
  { name: "Općina Posušje", image: opcinaPosuskeLogo, imgClass: "!object-contain !object-center scale-[1.5] translate-y-[6px]", url: null },
  { name: "Vokel d.o.o.", image: vokelLogo, imgClass: "!object-contain !object-center scale-[1.32]", url: "https://vokel.com/" },
  { name: "Ožujsko Pivo", image: ozujskoLogo, imgClass: "!object-contain !object-center scale-[1.5] translate-y-[8px]", url: null },
  ...
  { name: "Adeo Sports", image: adeoLogo, imgClass: "!object-contain !object-center scale-[2.16] translate-y-[4px]", url: null },
  ...
  { name: "Gaudeamus", image: gaudeamusLogo, imgClass: "!object-contain scale-[1.746]", url: null },
  ...
  { name: "SportsArt", image: sportsartLogo, imgClass: "!object-contain scale-[2.269]", url: null },
  ...
  { name: "Viva Caffe", image: vivaLogo, imgClass: "!object-contain scale-[2.088]", url: null },
  { name: "Antik", image: antikLogo, imgClass: "!object-contain scale-[1.597]", url: null },
  { name: "Wine&Co", image: winecoLogo, imgClass: "!object-contain scale-[2.178]", url: null },
  { name: "Astoria Restoran", image: astoriaLogo, imgClass: "!object-contain scale-[1.32]", url: null },
  { name: "Ž Barber Shop", image: barbershopLogo, imgClass: "!object-contain scale-[1.725]", url: null },
  ...
  { name: "Posuško Lito 2025", image: posuskoLitoLogo, imgClass: "!object-contain scale-[1.95]", url: null },
];
                ...
                <div className="flex gap-3 md:gap-4 mb-4 md:mb-6 mt-2 md:mt-4 overflow-x-auto pb-3 snap-x snap-mandatory scrollbar-thin" style={{ overflowX: 'auto', WebkitOverflowScrolling: 'touch' }}>
                  {sponsorTiers.map((tier, index) => {
                    ...
                    return (
                      <div
                        key={tier.name}
                        className={`group bg-secondary/40 border border-border rounded-lg p-3 md:p-4 animate-fade-in-up transition-all duration-300 hover:scale-[1.02] hover:border-primary/50 ${shadowColor} snap-start shrink-0 w-[calc(50%-6px)] md:w-[220px] lg:w-auto lg:flex-1 cursor-default select-none flex flex-col justify-center`}
