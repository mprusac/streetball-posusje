...
const sponsors = [
  { name: "Općina Posušje", image: opcinaPosuskeLogo, imgClass: "!object-contain scale-[1.32]", url: null },
  { name: "Vokel d.o.o.", image: vokelLogo, imgClass: "scale-[1.3]", url: "https://vokel.com/" },
  { name: "Ožujsko Pivo", image: ozujskoLogo, imgClass: "!object-contain scale-[1.32]", url: null },
  { name: "Meggle", image: meggleLogo, imgClass: "!object-contain scale-[1.02]", url: null },
  { name: "Pepsi", image: pepsiLogo, imgClass: "!object-contain scale-[1.32]", url: null },
  { name: "Bin Vest", image: binvestLogo, imgClass: "!object-contain scale-[1.6]", url: "https://binvest-po.com/" },
  { name: "Adeo Sports", image: adeoLogo, imgClass: "!object-contain scale-[1.32]", url: null },
  ...
  { name: "OLI Prodajni Centar", image: oliLogo, imgClass: "!object-contain scale-[1.32]", url: null },
  { name: "Gaudeamus", image: gaudeamusLogo, imgClass: "!object-contain scale-[1.1]", url: null },
  { name: "Penava Weddings", image: penavaLogo, imgClass: "!object-contain scale-[1.32]", url: null },
  ...
  { name: "Dravel", image: dravelLogo, imgClass: "!object-contain scale-[1.32]", url: null },
  { name: "Šišović Rakitno", image: sisovicLogo, imgClass: "!object-contain scale-[2.5]", url: "https://www.sisovic.com/" },
  { name: "Viva Caffe", image: vivaLogo, imgClass: "!object-contain scale-[1.32]", url: null },
  { name: "Antik", image: antikLogo, imgClass: "!object-contain scale-[1.1]", url: null },
  { name: "Wine&Co", image: winecoLogo, imgClass: "!object-contain scale-[1.32]", url: null },
  { name: "Astoria Restoran", image: astoriaLogo, imgClass: "!object-contain scale-[1.1]", url: null },
  { name: "Ž Barber Shop", image: barbershopLogo, imgClass: "!object-contain scale-[1.32]", url: null },
  { name: "Leda", image: ledaLogo, imgClass: "", url: "http://www.leda.ba/" },
  { name: "JV Studio", image: jvstudioLogo, imgClass: "!object-contain scale-[1.32]", url: null },
  { name: "Hydra Iso", image: hydraLogo, imgClass: "!object-contain scale-[1.1]", url: null },
  { name: "Markota", image: markotaLogo, imgClass: "!object-contain scale-[1.32]", url: null },
